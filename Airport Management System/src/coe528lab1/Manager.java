...
public class Manager {
    ...
    public static void main(String[] args){
        ...
        while(system){
            ...
            System.out.println();
            System.out.println(" 1.  To Create a Flight : Type 1");
            System.out.println(" 2.  To Display Available Flights : Type 2");
            System.out.println(" 3.  To Check a Flight (Get a Flight) : Type 3");
            System.out.println(" 4.  To Book a Seat : Type 4");
            System.out.println(" 5.  To Close Flight System : Type 5");
            System.out.println("--------------------------------------------");
